...
export default function Analytics() {
   ...
   if (isLoading) return <div className="p-8 text-slate-500 animate-pulse">Loading Analytics...</div>;
      ...
      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
         <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white p-6 rounded shadow-sm border gap-4">
            ...
            <div className="flex space-x-3">
               <button onClick={exportExcel} className="px-4 py-2 bg-emerald-50 text-emerald-600 hover:bg-emerald-100 rounded text-sm font-semibold transition-colors">
                  Download Report
               </button>
            </div>
         </div>
