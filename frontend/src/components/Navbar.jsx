...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#FFFFFF] sticky top-0 z-50 shadow-sm  backdrop-blur-md bg-opacity-80 dark:bg-opacity-80">
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <div className="flex items-center pl-6 border-l border-slate-200 dark:border-slate-700 space-x-4">
              {!currentUser ? (
                <>
                  <Link to="/signin" className="text-slate-500 hover:bg-blue-600 hover:text-white py-2 px-4 rounded text-sm font-medium transition-colors">
                    Login
                  </Link>
